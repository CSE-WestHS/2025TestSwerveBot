...
public class DriveConstants {
  ...
  public static final Rotation2d frontLeftZeroRotation =
      new Rotation2d(Rotations.of(-0.152832).in(Radians));
  public static final Rotation2d frontRightZeroRotation =
      new Rotation2d(Rotations.of(0.005859).in(Radians));
  public static final Rotation2d backLeftZeroRotation =
      new Rotation2d(Rotations.of(-0.055176).in(Radians));
  ...
  public static final double driveMotorReduction =
      ((14.0 / 50.0)
          * (27.0 / 17.0)
          * (15.0 / 45.0)); // MAXSwerve with 14 pinion teeth and 22 spur teeth
  ...
  public static final double turnMotorReduction = 7.0 / 150.0;
